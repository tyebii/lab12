...
=======
		...
		TreeNode getNodeWithName(String targetName)
		{
			...
			if (this.getName().equals(targetName)) {
				return this;
>>>>>>> 36ffdd6f0a334d495170284aa3117c9d72b338fc
			}
...
=======
		...
		// Find parent node. If root is null then the tree is empty then the parent node must be constructed.
		// Otherwise, the parent node should be somewhere in the tree.
...
<<<<<<< HEAD
		if (node1 == null)
			throw new TreeException("Node 1 doesnt exist");
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null)
			throw new TreeException("Node 2 doesnt exist");
